import __utils from './lib/utils.js'

import __token from './lib/token.js'

import __cookie from './lib/cookie.js'
...
function _routerBeforeEach (transition, routeAuth, cb) {
  var _this = this
  if (this.watch.authenticated && !__token.get.call(this)) {
    this.options.logoutProcess.call(this, null, {})
  }
  routeAuth = __utils.toArray((routeAuth || '').roles || routeAuth)
  // if (this.options.refreshData.enabled && __token.get.call(this)) {
  if (routeAuth && this.options.refreshData.enabled && __token.get.call(this)) {
    this.options.refreshPerform.call(this, {
      success: () => { _transitionEach.call(_this, transition, routeAuth, cb) }
    })
    return
  }
  _transitionEach.call(_this, transition, routeAuth, cb)
}
function _transitionEach (transition, routeAuth, cb) {
  var _this = this
  _checkAuthenticated.call(_this, () => {
    // eslint-disable-next-line one-var
...
function _loginbackPerform (data) {
  return __duckPunch.call(this, 'loginback', data)
}

function _loginbackProcess (res, data) {
  var _this = this
  __cookie.remember.call(this, data.rememberMe)
  this.authenticated = null
  this.options.fetchPerform.call(this, {
...
var defaultOptions = {
  ...
  loginbackData: {url: 'auth/loginback', method: 'POST', redirect: '/', fetchUser: true},
  ...
  loginbackPerform: _loginbackPerform,
  loginbackProcess: _loginbackProcess,
...
function Auth (Vue, options) {
  ...
  // Init interceptors.
  this.options.router._beforeEach.call(this, this.options.routerBeforeEach)
...
Auth.prototype.impersonating = function () {
  ...
  return !!__token.get.call(this, this.options.tokenImpersonateName)
}
...
Auth.prototype.loginback = function (data) {
  return __bindContext.call(this, 'loginback', data)
}
