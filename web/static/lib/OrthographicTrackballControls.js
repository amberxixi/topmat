...
THREE.OrthographicTrackballControls = function ( object, domElement ) {
	...
	this.zoomCamera = function () {
      ...
      // HH: set limit of factor such that it varies between (0.8, 1.2)
      let dy = (_zoomEnd.y - _zoomStart.y) * _this.zoomSpeed;
      var factor = Math.max(-0.2, Math.min(dy, 0.2)) + 1.0;
    ...
    // HH: add this line to enable rotation and pan
    _this.update()
	...
	function mousewheel( event ) {
		...
		_this.dispatchEvent( startEvent );
		_this.dispatchEvent( endEvent );
    // HH: add this line to enable zoom
    _this.update()
